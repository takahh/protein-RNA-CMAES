...
# output:
outfile = "/Users/mac/Documents/RNP_opt/optimize/Eval4_subset2_top30.csv"
outimg = "/Users/mac/Documents/RNP_opt/optimize/Eval4_subset2_top30.png"
...
def main():
    ...
    for sublist1 in low_pot_list:
        for i in range(3):
            ...
            sorted_list = sorted(sublist)[0:30]  # pot list sorted
            subtop10_list = []
            subtop10_int_list = []
        ...
        ax.vlines([1, 2], ymin=0, ymax=30, linewidth=5, color="white")
