...
def main():
    for subset in range(1, 5):
        best_pot_list = []
        out = path + f'plots/more_test_pot_boxplot_subset{subset}_allfolds.png'
        for fold in range(5):
            ...
            if subset == 4:
                ...
                logfile = path + f"cmaes_log_{fold}_subset{subset}_2021_02_08.txt"
            elif subset == 2:
        ...
        box_plot(best_pot_list, out, subset)
