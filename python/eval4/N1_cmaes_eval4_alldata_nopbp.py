...
def read_all_id(j, input_path):  # j: cpu num
    ...
    batchsize = int(len(id_list_all) / nprocess) + 1
    if j == nprocess - 1:
...
def calc_dots(arg_list):  # init_vec, fold_num, input_path
    ...
    for sublist in train_list:
        ...
        rank_list.append(apply_mean_final(set_id, init_vec, df_nega, df_posi))
